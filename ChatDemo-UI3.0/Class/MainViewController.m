...
- (void)setupSubviews
{
    ...
    [self selectedTapTabBarItems:_settingsVC.tabBarItem];
    {
        ...
        _joinVC = [[UIStoryboard storyboardWithName:@"Storyboard" bundle:[NSBundle mainBundle]] instantiateViewControllerWithIdentifier:@"JoinViewController"];
        _joinVC.tabBarItem = [[UITabBarItem alloc] initWithTitle:@"开始"
                                                               image:nil
                                                                 tag:0];
        [_joinVC.tabBarItem setFinishedSelectedImage:[UIImage imageNamed:@"tabbar_settingHL"]
                             withFinishedUnselectedImage:[UIImage imageNamed:@"tabbar_setting"]];
        _joinVC.view.autoresizingMask = UIViewAutoresizingFlexibleHeight;
        [self unSelectedTapTabBarItems:_joinVC.tabBarItem];
        [self selectedTapTabBarItems:_joinVC.tabBarItem];
    }
    
    self.viewControllers = @[_joinVC,_chatListVC, _contactsVC];
    [self selectedTapTabBarItems:_chatListVC.tabBarItem];
}
